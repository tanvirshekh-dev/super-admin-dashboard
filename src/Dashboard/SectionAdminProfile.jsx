...
const SectionAdminProfile = () => {
  ...
  const admins = [
    // Removed the extra curly braces around the image imports
    { id: 1, name: "Atikur Rahman Ashik", email: "atikir@email.com", role: "Institute Management", img: AtikurImg },
    { id: 2, name: "Sagor Robi", email: "sagor@email.com", role: "Register Management", img: SagorImg },
    { id: 3, name: "Md Akhil", email: "mahi@email.com", role: "Library Management", img: MahiImg },
    { id: 4, name: "Masum Billah", email: "masum@email.com", role: "Exam Control", img: MasumImg },
  ];

  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 m-8 shadow-sm">
      <h2 className="text-xl font-bold text-[#002B44] mb-6">Section Admin Profile</h2>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold text-gray-900">{admin.name}</span>
                <span className="text-sm text-gray-400 font-medium">{admin.email}</span>
